  ...
  $title = ' Daftar Topik';
  $desk = ' Tambah, Edit, Hapus dan Cari daftar topik';
  ...
  <main class="main">
             ...
             <div class="card">
                    ...
                    <div class="col-md-6 mb-1">
                      ...
                      <div class="col-md-4">
                        <div class="input-group">
                          ...
                          <input placeholder="Cari topik, Deskripsi, Nama modul ..." type="text" class="btn-outline-2x form-control global_filter" id="global_filter">
                        </div>
                      </div>
                  </div>
                     ...
                     <table style="width:100%" id="tabelAuthor" class="table table-sm  table-hover">
                       <thead>
                         <tr>
                           ...
                           <th></th>
                           <th style="width:3000px">Informasi Topik<br><small class="text-muted">(Nama Topik, Deskripsi, Nama Modul)</small></th>
                           <th></th>
                           <th></th>
               ...
               <div class="card-footer bg-light">
                 <p class="mr-auto mb-0 text-muted"><span class="text-danger">*</span>
                   <small> <small> Daftar Topik yang ditampilkan berdasarkan Group akun masing-masing! </small></small>
                 </p>
               </div>
             </div>
           </div>
           ...
           <form id="form" class="form-horizontal" method="POST">
             ...
             <div class="form-body">
               ...
               <div style="margin-top:-12px" class="form-group form-group-sm row">
                 <label for="sname" class="col-sm-3 col-form-label">Nama Topik<span class="text-danger">*</span></label>
                 <div class="col-sm-9">
                   <input placeholder="Nama Topik" id="sname" class="btn-outline-2x rounded-0 form-control" type="text" name="sname" value="" required>
                 </div>
               </div>

               <div style="margin-top:-12px" class="form-group form-group-sm row mb-2">
                 <label for="desk" class="col-sm-3 col-form-label">Deskripsi</label>
                 <div class="col-sm-9">
                   <textarea id="desk" class="btn-outline-2x rounded-0 form-control" placeholder="Deskripsi Topik" name="desk" rows="4"></textarea>
                 </div>
               </div>
   ...
   <script type="text/javascript" src="js/topik.js"></script>
<?php
