...
global $conn;
hakAkses('guru');
$title = ' Analisis Kegagalan Peserta Nilai Pengetahuan';
$desk = ' Hapus, Export, dan Cari Analisis Kegagalan peserta Nilai Pengetahuan';
...
<main class="main">
               ...
               <div id="content" class="hidden">
                 <div class="d-flex flex-wrap justify-content-between mb-1 mt-4">
                    <div class="col-md-6 mb-1">
                      ...
                      <a title="Export Detail Data" href="javascript:void(0)" id="exportdetaildata" class="float-left ml-1 mb-1 btn-sm btn-icon btn-pill btn btn-danger" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="cil-cloud-upload"></i> Export Detail Data
                      </a>
                      ...
                      <div class="col-md-4">
                        <div class="input-group">
                          ...
                          <input placeholder="Cari Materi, persentase..." type="text" class="btn-outline-2x form-control global_filter" id="global_filter">
                        </div>
                      </div>
                  </div>
                 <form class="mt-1" id="form" method="post" >
                   <div class="table-responsive" id="analisisp">
                     <table class="table table-hover ">
                       <thead id="daftaranalisisph">
                       </thead>
                       <tbody id="daftaranalisisp">
                       </tbody>
                     </table>
                   </div>
                 </form>
 ...
 <script type="text/javascript" src="js/persentasep.js"></script>
<?php
