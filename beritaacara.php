         ...
         <div class="col-lg-12">
           <div class="card">
             <div class="card-header bg-light text-dark">
               <i class="nav-icon icon-docs"></i><b>Cetak Berita Acara</b><b class="px-2"></b>
               <button class="btn btn-sm btn-pill float-right btn-primary px-3" onclick="modalba()"><i class="fa fa-gear"></i> Setting Berita Acara</button>
             </div>
             <div class="card-body">
               <div class="row">
                 <div class="table-responsive table-sm table-hover col-sm-12">
                   <form id="frm-users" action="#" method="POST">
                     <div class="form-group row">
                       <label class="col-sm-2 col-form-label-sm"><b>Ruang Ujian</b></label>
                       <div class="col-sm-10">
                         <input class="rounded-0 form-control form-control-sm " type="text" name="ruangUjian1" value="" id="ruangUjian1" placeholder="Ruang Ujian">
                       </div>
                     </div>
                     <div style="margin-top:-20px" class="form-group row">
                       <label class="col-sm-2 col-form-label-sm"><b>Jumlah Peserta</b></label>
                       <div class="col-sm-10">
                         <input class="rounded-0 form-control form-control-sm " type="text" name="jumlahPeserta" value="" id="jumlahPeserta" placeholder="Jumlah Peserta">
                       </div>
                     </div>
                     <div style="margin-top:-20px" class="form-group row">
                       <label class="col-sm-2 col-form-label-sm"><b>Jumlah Peserta Hadir</b></label>
                       <div class="col-sm-10">
                         <input class="rounded-0 form-control form-control-sm " type="text" name="jumlahPesertaHadir" value="" id="jumlahPesertaHadir" placeholder="Jumlah Peserta Hadir">
                       </div>
                     </div>
                     <div style="margin-top:-20px" class="form-group row">
                       <label class="col-sm-2 col-form-label-sm"><b>Jumlah Tidak Hadir</b></label>
                       <div class="col-sm-10">
                         <input class="rounded-0 form-control form-control-sm " type="text" name="jumlahTidakHadir" value="" id="jumlahTidakHadir" placeholder="Jumlah Peserta Tidak Hadir">
                       </div>
                     </div>
                     <div style="margin-top:-20px" class="form-group row">
                       <label class="col-sm-2 col-form-label-sm"><b>Username Tidak Hadir</b></label>
                       <div class="col-sm-10">
                         <input class="rounded-0 form-control form-control-sm " type="text" name="usernameTidakHadir" value="" id="usernameTidakHadir" placeholder="Username Tidak Hadir">
                       </div>
                     </div>
                     <div style="margin-top:-20px" class="form-group row">
                       <label class="col-sm-2 col-form-label-sm"><b>Catatan Selama Ujian</b></label>
                       <div class="col-sm-10">
                         <textarea class="rounded-0 form-control form-control-sm " name="catatanSelamaUjian" placeholder="Catatan Selama Ujian" id="catatanSelamaUjian" rows="3" cols="80"></textarea>
                       </div>
                     </div>
                     ...
                     <div class="form-group row">
                       ...
                       <div class="col-sm-10">
                         <button class="btn btn-warning btn-pill col-md-4 btn-sm" type="button" id="cetakBeritaAcara" name="cetakBeritaAcara"><i class="fa fa-print"></i> Cetak Berita Acara</button>
                     ...
                     <div style="margin-top:-12px;" class="mb-0 form-group row">
                       <label for="x_module" class="col-sm-2 col-form-label"></label>
                       <div class="col-sm-10">
                         <p class="small">*Ijinkan jendela Pop-Up pada browser anda untuk men-cetak Berita Acara!</p>
                       </div>
                     </div>
                   </form>
                 </div>
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer bg-light">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="nav-icon icon-reload"></i> Selesai</button>
                    <button type="button" class="btn btn-primary" name="btnSaveBA" id="btnSaveBA"><i class="nav-icon icon-doc"></i> Simpan Pengaturan</button>
                  </div>
                </div>
              </div>
            </div>
