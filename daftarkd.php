  ...
  $title = ' Daftar Kompeteni Dasar (KD) dan Materi';
  $desk = ' Tambah, Edit, Hapus dan Cari daftar Kompetensi Dasar (KD)';
                    ...
                    <div class="col-md-6 mb-1">
                      ...
                      <div class="col-md-4">
                        <div class="input-group">
                          ...
                          <input placeholder="Cari Kode Kd, Deskripsi, Nama modul ..." type="text" class="btn-outline-2x form-control global_filter" id="global_filter">
                        </div>
                      </div>
                  </div>
                     ...
                     <table style="width:100%" id="tabelAuthor" class="table table-sm  table-hover">
                       <thead>
                         <tr>
                           ...
                           <th></th>
                           <th style="width:5000px">Informasi Kompetensi Dasar (KD)<br><small class="text-muted">(Kode KD, Deskripsi, Modul dan Detail Taxonomy)</small></th>
                           <th></th>
                           <th></th>
                           <th></th>
           ...
           <form id="form" class="form-horizontal" method="POST">
             ...
             <div class="form-body">
               <div class="form-group form-group-sm row">
                 <label for="modul" class="col-sm-3 col-form-label">Nama Modul<span class="text-danger">*</span></label>
                 <div class="col-sm-9">
               ...
               <div style="margin-top:-12px" class="form-group form-group-sm row">
                 <label for="kodekd" class="col-sm-3 col-form-label">Kode KD<span class="text-danger">*</span></label>
                 <div class="col-sm-9">
                   <input placeholder="Kode KD, Ex: 3.1" id="kodekd" class="btn-outline-2x rounded-0 form-control" type="text" name="kodekd" value="" required>
                 </div>
               </div>

               <div  style="margin-top:-12px" class="form-group form-group-sm row mb-0">
                 <label for="deskkd" class="col-sm-3 col-form-label">Deskripsi</label>
                 <div class="col-sm-9">
                   <textarea id="deskkd" class="btn-outline-2x rounded-0 form-control" placeholder="Deskripsi Kompetensi Dasar" name="deskkd" rows="4"></textarea>
                 </div>
               </div>
