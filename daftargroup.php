  ...
  $title = ' Daftar Group';
  $desk = ' Tambah, Edit, Hapus dan Cari daftar group';
             ...
             <div class="card">
               ...
               <div class="card-body">
                    ...
                    <div class="col-md-6 mb-1">
                      ...
                      <div class="col-md-4">
                        <div class="input-group">
                          ...
                          <input placeholder="Cari Nama Group ..." type="text" class="btn-outline-2x form-control global_filter" id="global_filter">
                        </div>
                      </div>
                  </div>
                 ...
                 <form class="mt-0" id="form_table"  method="post" >
                     ...
                     <table style="width:100%" id="tabelAuthor" class="table table-sm  table-hover">
                       <thead>
                         <tr>
                           ...
                           <th></th>
                           <th style="width:5000px">Informasi Group<br><small class="text-muted">(Nama Group, Group ID, Dibuat tgl, Diedit tgl)</small></th>
                           <th></th>
                           <th></th>
                           <th></th>
                   ...
                   <input type="hidden" id="xnoted" name="xnoted" value="<?= $sesiLevel; ?>">
                 </form>
               </div>
               <div class="card-footer bg-light">
                 <p class="mr-auto mb-0 text-muted"><span class="text-danger">*</span>
                   <small> <small> Daftar group ditampilkan berdasarkan Group akun masing-masing! </small></small>
                 </p>
               </div>
             </div>
           </div>
           ...
           <form id="form" class="form-horizontal" method="POST">
             ...
             <div class="form-body">
               <div class="form-group form-group-sm row">
                 <label for="nama" class="col-sm-3 col-form-label">Nama Group<span class="text-danger">*</span></label>
                 <div class="col-sm-9">
                   <input placeholder="Nama Group" id="nama" class="btn-outline-2x rounded-0 form-control" type="text" name="nama" value="" required>
                 </div>
               </div>
            </div>
           </form>
