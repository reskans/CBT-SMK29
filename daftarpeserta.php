  ...
  $desk = ' Tambah, Edit, Hapus, Export, Import dan Cari daftar peserta';
           ...
           <div class="col-lg-12">
             <div class="card">
               <div class="card-header text-dark bg-light">
                 <b><i class="cil-contact"></i> <?= $title ?></b> ─ <small><?=$desk; ?></small>
               </div>
               <div class="card-body">
                    ...
                    <div class="col-md-6 mb-1">
                      <?php
                        ...
                        if ($sesiLevel >=10) {
                          ...
                          echo '<button type="button" title="Import Data" class="text-white float-left ml-1 mb-1 btn-sm btn-icon btn-pill btn btn-info " name="importdata" id="importdata"><i class="cil-cloud-download"></i> Import Data</button>';
                          echo '<button type="button" title="Export Data" class="float-left ml-1 mb-1 btn-sm btn-icon btn-pill btn btn-primary " name="exportdata" id="exportdata"><i class="cil-cloud-upload"></i> Export Data</button>';
                        }
                       ?>
                     ...
                     <table style="width:100%" id="tabelAuthor" class="table  table-responsive table-sm  table-hover">
                       <thead>
                         <tr>
                           ...
                           <th></th>
                           <th style="width:9000px">Informasi Biodata Peserta<br><small class="text-muted">(Username, Nama Lengkap - Jenis kelamin, Tgl dibuat)</small></th>
                           <th></th>
                           <th style="width:1000px">Group<br><small class="text-muted">(Daftar group)</small></th>
                           <th style="width:1000px">Akses<br><small class="text-muted">(1,2,3,5,10)</small></th>
               ...
               <div class="card-footer bg-light">
                 <p class="mr-auto mb-0 text-muted"><span class="text-danger">*</span>
                   <small> <small> Data semua peserta hanya ditampilkan dari akun Administrator! </small></small>
                 </p>
               </div>
             </div>
           </div>
